            ...
            <div class="tab-content">
                ...
                <div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <ul class="pagination">
                                <li class="page-item"><a class="page-link" href="${path}/manager/course?pnC=1">首页</a></li>

                                <c:if test="${coursePageInfo.hasPreviousPage }">
                                    <li class="page-item">
                                        <a class="page-link" href="${path}/manager/course?pnC=${coursePageInfo.pageNum-1}" aria-label="Previous">
                                ...
                                <c:forEach items="${coursePageInfo.navigatepageNums }" var="page_Num">
                                    ...
                                    <c:if test="${page_Num!=coursePageInfo.pageNum }">
                                        <li class="page-item"><a class="page-link" href="${path}/manager/course?pnC=${page_Num }">${page_Num }</a></li>
                                    </c:if>
                                </c:forEach>

                                <c:if test="${coursePageInfo.hasNextPage }">
                                    <li class="page-item">
                                        <a class="page-link" href="${path}/manager/course?pnC=${coursePageInfo.pageNum+1}" aria-label="Next">
                                            <span aria-hidden="true">&raquo;</span>
                                        </a>
                                    </li>
                                </c:if>

                                <li class="page-item"><a class="page-link" href="${path}/manager/course?pnC=${coursePageInfo.pages} ">末页</a></li>
                            </ul>
                        </div>
