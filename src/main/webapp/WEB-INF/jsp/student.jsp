        ...
        <div class="col-md-10">
            ...
            <div >
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <ul class="pagination">
                            <li class="page-item"><a class="page-link" href="${path}/manager/student?pnS=1">首页</a></li>

                            <c:if test="${studentPageInfo.hasPreviousPage }">
                                <li class="page-item">
                                    <a class="page-link" href="${path}/manager/student?pnS=${studentPageInfo.pageNum-1}" aria-label="Previous">
                            ...
                            <c:forEach items="${studentPageInfo.navigatepageNums }" var="page_Num">
                                ...
                                <c:if test="${page_Num!=studentPageInfo.pageNum }">
                                    <li class="page-item"><a class="page-link" href="${path}/manager/student?pnS=${page_Num }">${page_Num }</a></li>
                                </c:if>
                            </c:forEach>

                            <c:if test="${studentPageInfo.hasNextPage }">
                                <li class="page-item">
                                    <a class="page-link" href="${path}/manager/student?pnS=${studentPageInfo.pageNum+1}" aria-label="Next">
                                        <span aria-hidden="true">&raquo;</span>
                                    </a>
                                </li>
                            </c:if>

                            <li class="page-item"><a class="page-link" href="${path}/manager/student?pnS=${studentPageInfo.pages} ">末页</a></li>
                        </ul>
                    </div>
