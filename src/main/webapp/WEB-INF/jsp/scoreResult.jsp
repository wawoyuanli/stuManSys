        ...
        <div class="col-md-10">
            ...
            <div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <ul class="pagination">
                            <li class="page-item"><a class="page-link" href="${path}/score/search?pnSC=1">首页</a></li>

                            <c:if test="${scorePageInfo.hasPreviousPage }">
                                <li class="page-item">
                                    <a class="page-link" href="${path}/score/search?pnSC=${scorePageInfo.pageNum-1}&searchStuCou=${searchStuCou}" aria-label="Previous">
                            ...
                            <c:forEach items="${scorePageInfo.navigatepageNums }" var="page_Num">
                                ...
                                <c:if test="${page_Num!=scorePageInfo.pageNum }">
                                    <li class="page-item"><a class="page-link" href="${path}/score/search?pnSC=${page_Num }&searchStuCou=${searchStuCou}">${page_Num }</a></li>
                                </c:if>
                            </c:forEach>

                            <c:if test="${scorePageInfo.hasNextPage }">
                                <li class="page-item">
                                    <a class="page-link" href="${path}/score/search?pnSC=${scorePageInfo.pageNum+1}&searchStuCou=${searchStuCou}" aria-label="Next">
                                        <span aria-hidden="true">&raquo;</span>
                                    </a>
                                </li>
                            </c:if>

                            <li class="page-item"><a class="page-link" href="${path}/score/search?pnSC=${scorePageInfo.pages}&searchStuCou=${searchStuCou} ">末页</a></li>
                        </ul>
                    </div>
